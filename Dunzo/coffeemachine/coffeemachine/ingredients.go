...
//GetQuantity returns the current quantity and the bare minimum quantity of the ingredient
func (i *IngredientItem) GetQuantity() (int, int) {
	return i.quantity, i.bareminimum
}
